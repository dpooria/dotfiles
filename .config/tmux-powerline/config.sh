...
# battery.sh {
	...
	export TMUX_POWERLINE_SEG_BATTERY_TYPE="default"
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_GMAIL_USERNAME="dpooria75"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_GMAIL_PASSWORD="bsbd pdcr wxka ehlj "
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/home/podabb/.mail/inbox/new"
	
	## mbox
	# Path to the mbox to check.
	export TMUX_POWERLINE_SEG_MAILCOUNT_MBOX_INBOX="/var/spool/mail/podabb"
	
	## mailcheck
	# Optional path to mailcheckrc
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/home/podabb/.mailcheckrc"
# }
...
# weather.sh {
	...
	TMUX_POWERLINE_SEG_WEATHER_LAT="55.78593548719519"
	TMUX_POWERLINE_SEG_WEATHER_LON="12.520153404336948"
# }
